...
function Register() {
  ...
  async function handleSubmit(event) {
    ...
    try {
      const isAwaitingRegistration = await checkAwaitingRegistration(username);
      console.log("isAwaitingRegistration:", isAwaitingRegistration);
      if(isAwaitingRegistration) {
        ...
        console.log("User not allowed to register:", username);
      }
    } catch (e) {
