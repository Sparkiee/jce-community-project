...
function DisplayEvent(props) {
  ...
  return (
    <div className={`event-box ${isTitle ? "event-bold" : ""}`}>
      <div className={`event-field event-id ${isTitle ? "event-bold" : ""}`}>{props.event.id}</div>
      <div className={`event-field event-title ${isTitle ? "event-bold" : ""}`}>
        {props.event.eventName}
      </div>
      <div className={`event-field event-description ${isTitle ? "event-bold" : ""}`}>
      ...
      <div className={`event-field event-status ${isTitle ? "event-bold" : ""}`}>
        {props.event.eventStatus}
      </div>

      <div className={`event-field event-precentage ${isTitle ? "event-bold" : ""}`}>
        {!isTitle
