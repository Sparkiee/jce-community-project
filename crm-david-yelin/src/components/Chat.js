  ...
  const fetchUserChats = async () => {
    try {
      ...
      for (const doc of querySnapshot.docs) {
        ...
        const chat = doc.data();
        chatArray.push({ chatId: doc.id, otherUserEmail, fullName, ...chat });
      }
      setChats(chatArray);
    } catch (error) {
        ...
        <div className="chat-list-container">
          ...
          <div className="chat-list">
            ...
            {chats.map((chat, index) => (
              <div
                className={`chat-list-item ${selectedChat && selectedChat.chatId === chat.chatId ? "selected" : ""}`}
                key={index}
          ...
          <>
            <div className="chat-messages-container">
              ...
              <div className="chat-messages-bottom">
                ...
                <input type="text" placeholder="שלח הודעה..." value={text} onChange={(e) => setText(e.target.value)} />
